package com.dev.surya.facedetection;
            ...
            public void onSuccess(List<FirebaseVisionFace> firebaseVisionFaces) {
                ...
                for(FirebaseVisionFace face : firebaseVisionFaces) {
                    resultText = resultText.concat("\nNumber of Persons: "+i+".")
                            .concat("\nSmile: "+formatter.format(face.getSmilingProbability()*100)+"%")
                            .concat("\nLeftEye: "+formatter.format(face.getLeftEyeOpenProbability()*100)+"%")
                            .concat("\nRightEye: "+formatter.format(face.getRightEyeOpenProbability()*100)+"%");
